...
const Ribbon: React.FC<RibbonProps> = ({ href, children }) => (
  <div className="pointer-events-auto absolute top-0 left-0 z-10 h-[140px] w-[140px] overflow-hidden">
    <a
      ...
      className="absolute top-8 left-[-2.5rem] w-[160px] -rotate-45 bg-green-600 py-1 text-center text-sm font-bold tracking-wider text-white shadow-md duration-200 hover:scale-110"
    >
      {children}
